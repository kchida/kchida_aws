...
# This gets called by blog.urlroutes.BlogRoutes.show with 'blog' keyword argument.
# 'browse' is a view function
...
class LatestEntriesFeed(Feed):
    ...
    def item_description(self, post):
        ...
        header = '<p>TODO: Social buttons</p>' 
        footer = '<p>TODO: Social buttons</p>' 
