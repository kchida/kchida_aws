...
from apps.blog.utils import slugify
from apps.minicms.models import BaseContent
...
#TODO: Change this into a hash of URL and/or timestamp
...
class Post(BaseContent):
    ...
    def get_review_url(self):
        return ('apps.blog.views.review', (), {'review_key': self.review_key})
...
#TODO: Why does this have to be at the end?
